...
2/5/2023 I have ordered a !["I2c OLED Display 0.96"](https://www.amazon.com/gp/product/B076WXR8N9) and I just ordered a new much larger 3d printer. I will be making a custom front shell have version when I get the display. Again this case design is a modualer setup so it can be custom to one's needs for the front and back halfs. As well as the widge can be adjusted as desired as well.
